...
-(SKSpriteNode *)tutorialStepWithText:(NSString *)text{
    ...
    SKLabelNode *label = [SKLabelNode labelNodeWithFontNamed:@"changchengteyuanti"];
    label.text = text;
    label.fontSize = 12;
    ...
    SKLabelNode *detail = [SKLabelNode labelNodeWithFontNamed:@"changchengteyuanti"];
    detail.text = NSLocalizedString(@"Click to dismiss", nil) ;
    detail.fontSize = 10;
    detail.color = [UIColor whiteColor];
    detail.position = CGPointMake(label.position.x, label.position.y - 25);
    detail.name = @"TUTORIAL_STEP_DETAIL";
        ...
        switch (tutoStep) {
            case 0: {
                ...
                dispatch_once(&step1, ^{
                    ...
                    [self addChild:[self tutorialStepWithText:NSLocalizedString(@"Tilt your iphone to move monkey", nil)]];
            ...
            case 1: {
                ...
                dispatch_once(&step2, ^{
                    ...
                    [self addChild:[self tutorialStepWithText:NSLocalizedString(@"Catch coconut and tap to shoot", nil)]];
                    [self timerDismissTutorial];
                    [self pauseGameWithScene:NO];
                });
                break;
            ...
            case 2: {
                ...
                dispatch_once(&step3, ^{
                    ...
                    [self addChild:[self tutorialStepWithText:NSLocalizedString(@"Don't let ennemies destroy your tree", nil)]];
                    [self timerDismissTutorial];
                    [self pauseGameWithScene:NO];
                });
                break;
